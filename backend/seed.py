...
def show_menu():
    ...
    print("  2. Send Anthracnose Detection")
    print("  3. Send Powdery Mildew Detection")
    print()
    print("  FORECAST TESTS   (triggers forecast email)")
    print("  4. Send High Anthracnose Forecast")
    print("  5. Send High Powdery Mildew Forecast")
    print()
    print("  COMBINED TEST    (triggers both emails)")
    print("  6. Send Anthracnose + High Forecast")
    print()
