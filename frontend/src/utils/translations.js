const translations = {
  ...
  analysis: {
    ...
    overviewHighRiskTitle: { en: 'Disease pressure is elevated', am: 'የበሽታ ጫና ከፍ ብሏል' },
    overviewHighRiskBody: { en: 'Recent detections and forecast risk indicate the orchard may need quick intervention.', am: 'የቅርብ ጊዜ ግኝቶችና የትንበያ ስጋት ማሳያው ፈጣን ጣልቃ ገብነት ሊፈልግ እንደሚችል ያሳያሉ።' },
    ...
    actionNoAction: { en: 'No immediate action needed', am: 'አሁን የሚፈለግ አስቸኳይ እርምጃ የለም' },
    actionSpray: { en: 'Spray within 48h', am: 'በ48 ሰዓታት ውስጥ ይርጩ' },
    actionMonitor: { en: 'Increased monitoring recommended', am: 'ተጨማሪ ክትትል ይመከራል' },
    low: { en: 'Low', am: 'ዝቅተኛ' },
    medium: { en: 'Medium', am: 'መካከለኛ' },
    high: { en: 'High', am: 'ከፍተኛ' },
